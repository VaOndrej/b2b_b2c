...
import { resolveStorefrontContent } from "@won/core/storefront/storefront-content.engine";
import type { PageType } from "@won/core/storefront/storefront-content.types";
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const segment = await resolveSegmentForStorefront({
    ...
    loggedInCustomerId,
    b2bTag,
    e2eAudienceParam: url.searchParams.get(E2E_AUDIENCE_OVERRIDE_PARAM),
  });
